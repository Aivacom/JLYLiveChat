...
public class CustomPopWindow implements PopupWindow.OnDismissListener {
     ...
     * set position relative to the parent control
     *
     * @param parent  父控件
     * @param gravity
    ...
    private PopupWindow build() {
        ...
        if (mWidth == 0 || mHeight == 0) {
            ...
            //If the outside is not set, calculate the width and assign a value
    ...
    public void dissmiss() {
        ...
        //If the background is set to darken, restore it when dissmiss occurs
        if (mWindow != null) {
            WindowManager.LayoutParams params = mWindow.getAttributes();
            params.alpha = 1.0f;
            mWindow.setAttributes(params);
    ...
    public static class PopupWindowBuilder {
        ...
        /**
         * 设置背景变暗的值
         * Sets the value of the background to darken
         *
         * @param darkValue
         * @return
         */
        ...
        /**
         * 设置是否允许点击 PopupWindow之外的地方，关闭PopupWindow
         * Close PopupWindow by setting whether clicking outside the PopupWindow is allowed
         *
         * @param disMiss
         * @return
         */
